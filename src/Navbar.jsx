...
export default function Navbar() {
    ...
    return (
        <header className="sticky top-0 z-50 bg-[#f9f9ff] border-b border-[#d1c6ab] shadow-sm" dir="rtl">
            <div className="flex flex-row justify-between items-center px-5 py-4 w-full max-w-[1280px] mx-auto">
                {/* اللوجو واسم المتجر في أقصى اليمين */}
                ...
                {/* أيقونة السلة وزر القائمة في أقصى الشمال */}
                <div className="flex items-center gap-4">
                    <Link
                        to="/cart"
