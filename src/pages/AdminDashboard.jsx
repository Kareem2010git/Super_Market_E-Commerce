...
export default function AdminDashboard() {
  ...
  return (
    <div dir="rtl" className="flex min-h-screen bg-surface text-on-surface relative">
      ...
      <aside className="hidden lg:flex h-screen w-64 fixed right-0 top-0 bg-surface-container border-l border-outline-variant shadow-md z-40 flex-col justify-between">
        <div>
